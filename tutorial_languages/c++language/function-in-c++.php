...
<p>Functions are the set of statement that together perform a task. Every program written in c++ has at least one function, which is the "main" function. The keyword "function" is not a reserved keyword in c++ language.</p>
<h4><b><u>The main( ) as a function:</u></b></h4>
<p>In "c++ language" main ( ) function is the starting point of the program, and that's why every c++ language every program must have at least one function which us main ( ) function. This function usually has the control of the program by calling other functions. The keyword "main" is the reserved keyword. img #21.
</p>
...
<p>In "C++ language" there is some function know as a built-in function or already defined in the header file. forexample isupper(), toupper(), tolower() and islower(). </p>
...
<h4><b><u>Function without arguments and no-return values in c++:</u></b></h4>
...
<h4><b><u>Simple example of a function without arguments and without return value in c++</u></b></h4>
...
<span style="color: #888888"> Name        : simple-example-function-without-arguments-and-without-return-value-in-c++.cpp</span>
...
<span style="color: #333399; font-weight: bold">int</span> <span style="color: #0066BB; font-weight: bold">main</span>() {
	cout<span style="color: #333333">&lt;&lt;</span><span style="background-color: #fff0f0">&quot;Function is calling&quot;</span>;
	say_Hello();
}
</pre></td></tr></table></div>
...
<h4><b><u>Function without arguments and return value in c++:</u></b></h4>
...
<h4><b><u>Simple example of a function without arguments and return value in c++</u></b></h4>
<pre class="prettyprint">
<div align="center">
<div style="background: #ffffff; overflow:auto;width:auto;border:solid gray;border-width:.1em .1em .1em .8em;padding:.2em .6em;"><table><tr><td><pre style="margin: 0; line-height: 125%"> 1
 2
...
<span style="color: #888888"> ============================================================================</span>
<span style="color: #888888"> Name        : Simple-example-function-without-arguments-and-return-value-in-c++.cpp</span>
<span style="color: #888888"> Author      : CodingSlice</span>
<span style="color: #888888"> Version     :</span>
<span style="color: #888888"> Copyright   : Your copyright notice</span>
<span style="color: #888888"> Description : Simple example function without arguments and return values in c++</span>
<span style="color: #888888"> ============================================================================</span>
<span style="color: #888888"> */</span>
...
<span style="color: #333399; font-weight: bold">int</span> <span style="color: #0066BB; font-weight: bold">main</span>() {
	cout<span style="color: #333333">&lt;&lt;</span><span style="background-color: #fff0f0">&quot;Function is calling&quot;</span>;
    cout<span style="color: #333333">&lt;&lt;</span><span style="background-color: #fff0f0">&quot;</span><span style="color: #666666; font-weight: bold; background-color: #fff0f0">\n</span><span style="background-color: #fff0f0">Result is &quot;</span><span style="color: #333333">&lt;&lt;</span> add();
}
</pre></td></tr></table></div>
...
21</pre></td><td><pre style="margin: 0; line-height: 125%"><span style="color: #888888">/*</span>
<span style="color: #888888"> ============================================================================</span>
<span style="color: #888888"> Name        : simple-example-of-a-function-with-arguments-and-return-value-in-c++.cpp</span>
<span style="color: #888888"> Author      : CodingSlice</span>
<span style="color: #888888"> Version     :</span>
<span style="color: #888888"> Copyright   : Your copyright notice</span>
...
<span style="color: #333399; font-weight: bold">int</span> <span style="color: #0066BB; font-weight: bold">main</span>() {
	cout<span style="color: #333333">&lt;&lt;</span><span style="background-color: #fff0f0">&quot;Function is calling&quot;</span>;
		cout<span style="color: #333333">&lt;&lt;</span><span style="background-color: #fff0f0">&quot;</span><span style="color: #666666; font-weight: bold; background-color: #fff0f0">\n</span><span style="background-color: #fff0f0">The result of adding two number is : &quot;</span><span style="color: #333333">&lt;&lt;</span> add(<span style="color: #0000DD; font-weight: bold">6</span>,<span style="color: #0000DD; font-weight: bold">2</span>);
}
</pre></td></tr></table></div>
...
<h4><b><u>simple example using return keyword in c++</u></b></h4>
<pre class="prettyprint">
<div align="center">
...
<span style="color: #888888"> ============================================================================</span>
<span style="color: #888888"> Name        : simple-example-using-return-keyword-in-c++.cpp</span>
<span style="color: #888888"> Author      : CodingSlice</span>
<span style="color: #888888"> Version     :</span>
<span style="color: #888888"> Copyright   : Your copyright notice</span>
...
<span style="color: #888888">	 */</span>
	...
	cout<span style="color: #333333">&lt;&lt;</span><span style="background-color: #fff0f0">&quot;Statement 2&quot;</span>;
}
</pre></td></tr></table></div>
