...
<h4><b><u>Decision making (if statement)</u></b> </h4>
<p>
...
{
   printf(<span style="background-color: #fff0f0">&quot;Condition is true);</span>
}

<span style="color: #008800; font-weight: bold">if</span>(condition2 is <span style="color: #007020">true</span>)
{
    printf(<span style="background-color: #fff0f0">&quot;condition2 is true&quot;</span>);
}
</pre></td></tr></table></div>
...
<h4><b><u>Switch statements (Selection statements)</u></b></h4>
...
{ 
    ...
    printf(<span style="background-color: #fff0f0">&quot;This is case one&quot;</span>);
    ...
    printf(<span style="background-color: #fff0f0">&quot;This is case two&quot;</span>);
    <span style="color: #997700; font-weight: bold">break:</span>
    <span style="color: #008800; font-weight: bold">case</span> <span style="color: #0000DD; font-weight: bold">3</span>:
    printf(<span style="background-color: #fff0f0">&quot;This is case three&quot;</span>);
    <span style="color: #997700; font-weight: bold">break:</span>
    <span style="color: #997700; font-weight: bold">default:</span>
    printf(<span style="background-color: #fff0f0">&quot;This is not a case one, case two or case three.</span>
}
</pre></td></tr></table></div>
</div>
</pre>
...
6
7
8</pre></td><td><pre style="margin: 0; line-height: 125%">printf(<span style="background-color: #fff0f0">&quot;Statement 1&quot;</span>);
Goto Label;
<span style="color: #888888">//Statement 2 and Statement 3 will be skip</span>
printf(<span style="background-color: #fff0f0">&quot;Statement 2&quot;</span>);
printf(<span style="background-color: #fff0f0">&quot;Statement 3&quot;</span>);
<span style="color: #888888">//Control of program is here now</span>
Label;
printf(<span style="background-color: #fff0f0">&quot;Statement 4&quot;</span>);
</pre></td></tr></table></div>
...
9</pre></td><td><pre style="margin: 0; line-height: 125%"><span style="color: #008800; font-weight: bold">for</span>(condition) 
    { 
	printf(<span style="background-color: #fff0f0">&quot;Repeat untill condition is true&quot;</span>);
	}

<span style="color: #008800; font-weight: bold">while</span> (condition)
    {
	printf(<span style="background-color: #fff0f0">&quot;Repeat while condition is true&quot;</span>)
	}
</pre></td></tr></table></div>
...
7
8
9</pre></td><td><pre style="margin: 0; line-height: 125%"><span style="color: #333399; font-weight: bold">int</span> number <span style="color: #333333">=</span> <span style="color: #0000DD; font-weight: bold">2</span>;
...
<span style="color: #333399; font-weight: bold">int</span> <span style="color: #0066BB; font-weight: bold">main</span>(<span style="color: #333399; font-weight: bold">void</span>) {
	<span style="color: #888888">//check if the number is greater or less then 10</span>
	(number <span style="color: #333333">&gt;</span> <span style="color: #0000DD; font-weight: bold">10</span>) <span style="color: #333333">?</span>
			(printf(<span style="background-color: #fff0f0">&quot;The number is greater than 10&quot;</span>)) <span style="color: #333333">:</span>
			(printf(<span style="background-color: #fff0f0">&quot;Number is less than or equal to 10&quot;</span>));
