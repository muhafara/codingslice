...
<span style="color: #888888"> Name        : simple-example-using-arithmetic-operator-in-c.c</span>
...
<span style="color: #333399; font-weight: bold">int</span> <span style="color: #0066BB; font-weight: bold">main</span>(<span style="color: #333399; font-weight: bold">void</span>) {
	...
	printf(
			<span style="background-color: #fff0f0">&quot;........................Arithmetic Operator.......................&quot;</span>);
	<span style="color: #888888">//Operator (&#39;+&#39;)</span>
	printf(<span style="background-color: #fff0f0">&quot;</span><span style="color: #666666; font-weight: bold; background-color: #fff0f0">\n</span><span style="background-color: #fff0f0">Adding two number with + %d&quot;</span>, num_One <span style="color: #333333">+</span> num_Two);
	<span style="color: #888888">//Operator (&#39;-&#39;)</span>
	printf(<span style="background-color: #fff0f0">&quot;</span><span style="color: #666666; font-weight: bold; background-color: #fff0f0">\n</span><span style="background-color: #fff0f0">Subtracting two number with + %d&quot;</span>, num_One <span style="color: #333333">-</span> num_Two);
	<span style="color: #888888">//Operator (&#39;*&#39;)</span>
	printf(<span style="background-color: #fff0f0">&quot;</span><span style="color: #666666; font-weight: bold; background-color: #fff0f0">\n</span><span style="background-color: #fff0f0">Multiplying two number with + %d&quot;</span>, num_One <span style="color: #333333">*</span> num_Two);
	<span style="color: #888888">//Operator (&#39;/&#39;)</span>
	printf(<span style="background-color: #fff0f0">&quot;</span><span style="color: #666666; font-weight: bold; background-color: #fff0f0">\n</span><span style="background-color: #fff0f0">Dividing two number with + %d&quot;</span>, num_One <span style="color: #333333">/</span> num_Two);
	<span style="color: #888888">//Operator (++)</span>
	num_One<span style="color: #333333">++</span>;
	printf(<span style="background-color: #fff0f0">&quot;</span><span style="color: #666666; font-weight: bold; background-color: #fff0f0">\n</span><span style="background-color: #fff0f0">Increment number with ++ %d&quot;</span>, num_One);
	<span style="color: #888888">//Operator (--)</span>
	num_One<span style="color: #333333">=</span><span style="color: #0000DD; font-weight: bold">8</span>;
	num_One<span style="color: #333333">--</span>;
	printf(<span style="background-color: #fff0f0">&quot;</span><span style="color: #666666; font-weight: bold; background-color: #fff0f0">\n</span><span style="background-color: #fff0f0">Decrement number with -- %d&quot;</span>, num_One);
}
</pre></td></tr></table></div>
</div>
</pre>
...
44
45
46</pre></td><td><pre style="margin: 0; line-height: 125%"><span style="color: #888888">/*</span>
<span style="color: #888888"> ============================================================================</span>
<span style="color: #888888"> Name        : simple-example-on-relational-operator-in-c.c</span>
<span style="color: #888888"> Author      : CodingSlice</span>
<span style="color: #888888"> Version     :</span>
<span style="color: #888888"> Copyright   : Your copyright notice</span>
...
<span style="color: #333399; font-weight: bold">int</span> num_One<span style="color: #333333">=</span><span style="color: #0000DD; font-weight: bold">8</span>,num_Two<span style="color: #333333">=</span><span style="color: #0000DD; font-weight: bold">4</span>;
<span style="color: #333399; font-weight: bold">int</span> <span style="color: #0066BB; font-weight: bold">main</span>(<span style="color: #333399; font-weight: bold">void</span>) {
	printf(<span style="background-color: #fff0f0">&quot;........................Relational Operator.......................&quot;</span>);
		<span style="color: #888888">/*</span>
...
<span style="color: #888888"> ============================================================================</span>
<span style="color: #888888"> Name        : simple-example-using-logical-operator-in-c.c</span>
<span style="color: #888888"> Author      : CodingSlice</span>
<span style="color: #888888"> Version     :</span>
<span style="color: #888888"> Copyright   : Your copyright notice</span>
...
<h4><b><u>Assignment Operator</u></b></h4>
...
<h4><b><u> Bitwise operator</u></b></h4>
